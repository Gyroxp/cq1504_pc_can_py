...
class Ui_dlgMain(object):
    def setupUi(self, dlgMain):
        ...
        self.label_3.setGeometry(QtCore.QRect(556, 20, 48, 16))
        self.label_3.setObjectName(_fromUtf8("label_3"))
        self.label_4 = QtGui.QLabel(dlgMain)
        self.label_4.setGeometry(QtCore.QRect(698, 20, 36, 16))
        ...
        dlgMain.setTabOrder(self.lineEdit_GPID, self.textEdit_recv)
